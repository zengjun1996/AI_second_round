...
from tensorflow.keras.layers import Input, add, Dense, Dropout, Reshape, Conv2D
from tensorflow.keras.layers import BatchNormalization, LeakyReLU, MaxPooling2D, Flatten
...
path = 'saved_models/model_121_{epoch:03d}.h5'
